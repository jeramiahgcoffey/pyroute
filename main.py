...
truck_1.deliver_packages(datetime.timedelta(seconds=28800))
truck_2.deliver_packages(datetime.timedelta(seconds=32700))
truck_3.deliver_packages(truck_1.return_time)
